...
public class UserIndexWindow extends JFrame {
	...
	private void initialize() {
		...
		this.setBounds(700, 200, 450, 770);
		...
		gbc_panel_1.gridx = 0;
		gbc_panel_1.gridy = 0;
		this.getContentPane().add(userPanel, gbc_panel_1);
		...
		this.getContentPane().add(scrollPane, gbc_panel);
		...
		this.getContentPane().add(moreMessageButton, gbc_moreMessageButton);
